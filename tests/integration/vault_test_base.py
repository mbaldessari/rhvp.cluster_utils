#!/usr/bin/env python
"""
Base class for Vault integration tests to eliminate code duplication
"""
...
class VaultTestBase(unittest.TestCase):
    """Base class for Vault integration tests with shared setup/teardown functionality"""
    ...
    def setUpClass(cls):
        ...
        # Perform any subclass-specific setup
        cls._subclass_setup()
    ...
    def _subclass_setup(cls):
        """Override in subclasses for additional setup after Vault is ready"""
        pass
    ...
    def check_podman_availability():
        """Check if Podman is available and running - call this in __main__"""
        try:
