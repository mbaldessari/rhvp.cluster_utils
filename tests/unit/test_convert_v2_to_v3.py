...
from convert_v2_to_v3 import V2ToV3Converter
...
rule "charset" { charset = "!@#%^&*" min-chars = 1 }'''
    ...
    def test_convert_field_generate(self):
        ...
        field_name, field_value = self.converter.convert_field_to_v3(field, {'basicPolicy': 'some_policy'})
    ...
    def test_convert_field_optional_file(self):
        ...
        self.assertEqual(field_value, {'value': 'file:///path/to/cert.pem', 'optional': True})
        ...
        v2_secrets = [
            {
                ...
                'fields': [
                    ...
                    {'name': 'password', 'onMissingValue': 'generate', 'vaultPolicy': 'basic'}
                ]
            },
            {
                'name': 'certificates',
                'fields': [
                    {'name': 'ca_cert', 'path': '/certs/ca.pem'}
                ]
            }
        ]
...
rule "charset" { charset = "abc" min-chars = 1 }'''
        ...
        self.assertTrue(any("Converted policy 'test'" in msg for msg in self.converter.conversion_log))
    ...
    def test_vault_mount_warning(self):
        ...
        warning_logged = any("vaultMount" in msg and "WARNING" in msg for msg in self.converter.conversion_log)
        self.assertTrue(warning_logged, "Expected warning about vaultMount not being logged")
